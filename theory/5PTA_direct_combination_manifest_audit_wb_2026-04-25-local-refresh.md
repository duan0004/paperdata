...
- InPTA product used for this audit: `WB`.
...
|---|---|---|---:|
| `J1857+0943` | `B1855+09;J1857+0943` | `EPTA;InPTA_WB;NG15;PPTA` | 4 |
| `J1939+2134` | `B1937+21;J1939+2134` | `InPTA_WB;NG15;PPTA` | 3 |
...
- Occurrence CSV: `results/5pta_timing/direct_combination_manifest_audit_wb_2026-04-25-local-refresh_occurrences.csv`.
- Group CSV: `results/5pta_timing/direct_combination_manifest_audit_wb_2026-04-25-local-refresh_groups.csv`.
- JSON: `results/5pta_timing/direct_combination_manifest_audit_wb_2026-04-25-local-refresh.json`.
