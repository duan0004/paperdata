...
Recent public-data studies have separately pursued direct multi-PTA data
combination \cite{FivePTA_2026}, Fourier-space reuse of posterior
summaries \cite{Valtolina_Haasteren_2025}, and Bayesian discrimination
among selected source classes \cite{Lai_Li_2025}.  Our bridge is
different: we anchor source identification to the official
...
the resulting non-identification survives a deliberately limited
cross-PTA posterior-summary bridge.
...
baseline.  Because only the NANOGrav term is anchored to the official
PTArcade density in this bridge pipeline, \texttt{hybrid3} should be
interpreted as an anchored source-ranking stress test rather than as a
fully calibrated multi-PTA Bayes-factor scale.  It is a controlled test
of whether public spectral summaries already identify a unique source
class.
...
a priori convergence threshold of $1.05$.
...
evidence by source family using an equal-weight mixture over the tested
representatives.}
\end{figure}
...
checks.  This is an anchored ranking stress test, not a fully calibrated
multi-PTA Bayes-factor scale.  In the local3 bridge the leading tested
...
plateau diagnostics, and robustness checks.  In the single-configuration
official scan the
...
\href{https://github.com/duan0004/paperdata/tree/prl-calibration-bridge-2026-04-23}
{\texttt{prl-calibration-bridge-2026-04-23}}.
