...
def write_md():
    ...
    if d["family_pass"]:
        lines.append(
            "At least two curved-SMBHB parameterizations overlap the leading "
            "cosmological evidence tier within one nat.  The environmental row is "
            "an astrophysical SMBHB control, while the broken-power-law and "
            "eccentricity-inspired rows are phenomenological low-frequency "
            "suppression controls.  This supports a family-level "
